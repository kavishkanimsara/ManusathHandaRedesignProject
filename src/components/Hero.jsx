                ...
                >
                    <div className=' text-gray-700 py-8 md:w-1/2'>
                        <div className='text-center md:text-left'>
                            <h1 className='text-6xl md:text-7xl font-semibold '>e-<span className='text-primary text-5xl md:text-6xl '>Library</span></h1>
                            <h2 className='text-2xl sm:text-3xl md:text-5xl my-5 font-semibold '>The Smarter way</h2>
                            <h2 className='text-2xl sm:text-3xl md:text-5xl my-5 font-semibold '>To Learn <span className=' text-primary'>Anything</span></h2>
                        </div>
                        <div className=' my-3 font-normal text-center md:text-left '>
                            <p className='md:pr-12'>An initiative of <span className=' text-primary'>Rotaract Mora</span> to uplift the education for the
                        ...
                        <div className='mx-12 md:mx-0'>
                            <AnchorLink href='#category'>
                                <button className='py-3 mt-8 px-8 rounded-full bg-gradient-to-b from-primary to-[#D60070] text-white font-medium '>Start Learning</button>
                            </AnchorLink>
                        </div>
