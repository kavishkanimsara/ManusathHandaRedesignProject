                ...
                <div className='py-12 px-8 md:px-16 bg-rose-100'>
                    ...
                    <div className=' flex flex-wrap gap-8 justify-center'>
                        { props.categoryData.map((data, index) => (
                            <div key={index} className="md:max-w-xs w-full bg-white border border-gray-200 rounded-lg shadow ">
                                <a href={"/"+CategoryPath+data.link}>
                                    <img class="rounded-t-lg" src={data.imageUrl|defaultImgUrl} alt={data.name + ' image'} />
                                </a>
